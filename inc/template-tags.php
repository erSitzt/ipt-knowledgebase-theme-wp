...
/**
 * Prints HTML with meta information for the current post-date/time and author, with FontAwesome icons.
 */
function ipt_kb_posted_on() {
	...
	// Add FontAwesome calendar and user icons
	echo '<span class="me-3 text-secondary"><i class="fa-regular fa-calendar"></i> ' . $time_string . '</span>';
	echo '<span class="me-3 text-secondary"><i class="fa-regular fa-user"></i> <a class="text-decoration-none text-secondary" href="' . esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ) . '">' . esc_html( get_the_author() ) . '</a></span>';
}
endif;
